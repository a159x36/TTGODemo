...
esp_hid_scan_result_t *bt_scan_results = NULL;
static size_t num_bt_scan_results = 0;

esp_hid_scan_result_t *ble_scan_results = NULL;
...
void esp_hid_scan_async(uint32_t seconds) {
    start_ble_scan(seconds);
    start_bt_scan(seconds);
}
